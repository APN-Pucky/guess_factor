...
#include <sstream>
void read_line(std::string line, std::string key, std::vector<double>& ret, bool print=true) {
    auto str = line;
...
void read_params(std::string fn, std::vector<double>& bases,std::vector<double>& exponents, bool print)
{
